...
/*Створив базу даних SHOP*/

CREATE TABLE SALES (
    SALES_ORDER_ID INT PRIMARY KEY, -- Унікальний ідентифікатор замовлення
    REVISION_NUMBER TINYINT NOT NULL, -- Інкремент для відстеження зміни за замовленням
    ...
    ONLINE_ORDER_FLAG BIT NOT NULL, -- 0 = Замовлення було створено менеджером. 1 = Замовлення було створено онлайн
    CUSTOMER_ID INT NOT NULL, -- Унікальний ідентифікатор клієнта, який здійснив замовлення
    SALES_PERSON_ID INT, -- Унікальний ідентифікатор співробітника, який провів замовлення
    TERRITORY_ID INT, -- Унікальний ідентифікатор території - число без дробової частини
    SUB_TOTAL DECIMAL(18, 4) NOT NULL, -- Загальна сума замовлення - грошова величин
    TAX_AMT DECIMAL(18, 4) NOT NULL, -- Загальна сума податків - грошова величина
    FREIGHT DECIMAL(18, 4) NOT NULL, -- Сума доставки - грошова величина - не більше 214748.364
    MODIFIED_DATE DATETIME NOT NULL, -- Дата і час останньої зміни рядка
);
/* Створив таблицю SALES*/
...
(43678, 8, '2011-05-31 00:00:00.000', '2011-06-12', '2011-06-07', 0, 29889, 281, 4, 9799.9243 , 942.074 ,294.3981 ,'2011-06-07 00:00:00.000')/*Внес дані до таблиці*/

-- Вніс дані до таблиці
